...
public class CANdleSystem extends SubsystemBase {
    ...
    public CANdleSystem(XboxController joy, IndexSubsystem index) {
        this.joystick = joy;
    ...
    public void BaseLEDLights() {
        m_toAnimate = new ColorFlowAnimation(128, 20, 70, 0, 0.7, LedCount, Direction.Forward);
    }
    public void setPinknoIndex() {
        

            m_candle.setLEDs(128, 20, 20, 255, 0, 68);
    }
    public void setPink() {
        if (index.getLimit()) {
            setOrange();
    ...
    public void setGreen() {
        m_candle.setLEDs(0, 255, 0, 255, 0, 68);
    }

    public void setBlue() {
        m_candle.setLEDs(0, 0, 255, 255, 0, 68);
    }

    public void setOrange() {

        m_candle.setLEDs(255, 20, 0, 255, 0, 68);
    }

    public void setWhite() {
        m_candle.setLEDs(255, 255, 255, 255, 0, 68);
    }
    ...
    // break;
    // case Larson:
    // m_toAnimate = new LarsonAnimation(0, 255, 46, 0, 1, LedCount,
    // BounceMode.Front, 3);
    // break;
    // case Rainbow:
